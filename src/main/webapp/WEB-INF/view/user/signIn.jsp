...
<div class="col-sm-8">
	...
	<div class="bg-light p-md-5 h-75">
		...
		<a href="https://kauth.kakao.com/oauth/authorize?client_id=3b28864879151fe9883b2b512923e205
		&redirect_uri=http://localhost:8080/auth/kakao/callback&response_type=code">
			<img alt="" src="/images/kakao_login_small.png" style="width: 75; height: 40;">
		</a>
	</div>
</div>
